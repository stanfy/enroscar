...
import com.stanfy.utils.notifications.GingerbreadNotificationBuilder;
...
public class GingerbreadUtils extends LowestSDKDependentUtils {
  ...
  public NotificationBuilder createNotificationBuilder(final Context context) {
    return new GingerbreadNotificationBuilder(context);
  }
