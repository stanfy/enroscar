...
public final class Base64 {
  ...
  throws IOException {
    ...
    try {
      ...
      try { oos.close();   } catch (final Exception e) { ignore(); }
      try { gzos.close();  } catch (final Exception e) { ignore(); }
      try { b64os.close(); } catch (final Exception e) { ignore(); }
      try { baos.close();  } catch (final Exception e) { ignore(); }
    }   // end finally
    ...
    if ((bytes != null) && (bytes.length >= c4) && (!dontGunzip)) {
      ...
      if (java.util.zip.GZIPInputStream.GZIP_MAGIC == head)  {
        ...
        try {
          ...
          try { baos.close(); } catch (final Exception e) { ignore(); }
          try { gzis.close(); } catch (final Exception e) { ignore(); }
          try { bais.close(); } catch (final Exception e) { ignore(); }
        }   // end finally
  ...
  throws IOException, java.lang.ClassNotFoundException {
    ...
    try {
      ...
      try { bais.close(); } catch (final Exception e) { ignore(); }
      try { ois.close();  } catch (final Exception e) { ignore(); }
    }   // end finally
  ...
  throws IOException {
    ...
    try {
      ...
      try { bos.close(); } catch (final Exception e) { ignore(); }
    }   // end finally
  ...
  throws IOException {
    ...
    try {
      ...
      try { bis.close(); } catch (final Exception e) { ignore(); }
    }   // end finally
  ...
  throws IOException {
    ...
    try {
      ...
      try { out.close(); } catch (final Exception ex) { ignore(); }
    }   // end finally
