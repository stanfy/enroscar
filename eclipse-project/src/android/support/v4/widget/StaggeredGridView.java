...
public class StaggeredGridView extends ViewGroup {
  ...
  private ArrayList<FixedViewInfo> mHeaderViewInfos = new ArrayList<StaggeredGridView.FixedViewInfo>();
  private ArrayList<FixedViewInfo> mFooterViewInfos = new ArrayList<StaggeredGridView.FixedViewInfo>();

  private final Runnable layoutRequestRunnable = new Runnable() {
    @Override
  ...
  private boolean trackMotionScroll(final int deltaY, final boolean allowOverScroll) {
    if (mItemCount <= mHeaderViewInfos.size() + mFooterViewInfos.size() + 1
        || getChildCount() <= mHeaderViewInfos.size() + mFooterViewInfos.size() + 1) {
      // XXX HACK
      // do not fillUp/Down when there is too few items in layout
      return false;
    }
  ...
  public void removeHeaderViews() {
    ...
    if (mAdapter instanceof HeaderViewListAdapter) {
      ((HeaderViewListAdapter) mAdapter).removeHeaders();
    }
  }
  ...
  public void removeFooterViews() {
    ...
    if (mAdapter instanceof HeaderViewListAdapter) {
      ((HeaderViewListAdapter) mAdapter).removeFooters();
    }
  }
  ...
  public static class LayoutParams extends ViewGroup.LayoutParams {
    ...
    public static final int SPAN_MAX = Integer.MAX_VALUE;
  ...
  private class RecycleBin {
    ...
    public void addScrap(final View v) {
      ...
      if (viewType == AdapterView.ITEM_VIEW_TYPE_IGNORE
          || viewType == AdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER) { return; }
    ...
    public View getScrapView(final int type) {
      if (type == AdapterView.ITEM_VIEW_TYPE_IGNORE
          || type == AdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER) { return null; }
  ...
  private class AdapterDataSetObserver extends DataSetObserver {
    ...
    public void onChanged() {
      ...
      removeCallbacks(layoutRequestRunnable);
      post(layoutRequestRunnable);
